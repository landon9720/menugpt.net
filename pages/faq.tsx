  ...
  return (
    <>
      ...
      <p>
        ...
        choices are generated by the AI, and selected by the user. It's like a
        choose-your-own-adventure. Each input and AI response gets a permanent
        and public web page. The pages are linked together by parent-child
        relationships. The result is a tree-shaped graph of pages.
      </p>
